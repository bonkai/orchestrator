...
|---|---|---|---|---|
| claude | stream-json result usage; `dispatches.cost_usd` | CLI limit-warning strings (⧗ pin exact text) | ⧗ interactive `/usage` only — no known headless readout | claude.ai → Settings → Usage |
