...
All "brain" calls (rewriter + summarizer) use headless `claude` subprocesses — same pattern as `~/Documents/verse_sites/pipeline_lib.stream_run`. Uses your existing Claude subscription. Zero API tokens for the orchestrator itself.
