#!/usr/bin/env python3
"""Fusion provider script — Zhipu / Z.ai GLM (OpenAI-compatible endpoint).
...
def _key():
    """Precedence: env ZAI_API_KEY → config.json api_key → '' (mirrors
